...
struct SimulationDestinationView: View {
    ...
    var body: some View {
        ...
        case .balancedForces:
            ForcesLabView(curriculum: curriculum, repository: repository)
        case .centreOfGravity:
            CentreOfGravityLabView(curriculum: curriculum, repository: repository)
        case .magneticFieldWire:
            MagneticFieldLabView(curriculum: curriculum, repository: repository)
        case .planeMirrorReflection:
            ReflectionLabView(curriculum: curriculum, repository: repository)
        default:
...
struct GenericSimulationView: View {
    ...
    private var iconName: String {
        ...
        case .lensFocusing, .refraction, .planeMirrorReflection: return "eye.fill"
        case .potentiometer: return "slider.horizontal.3"
        case .moments, .balancedForces: return "scalemass.fill"
        ...
        case .centreOfGravity: return "scope"
        case .magneticFieldWire: return "location.north.line"
        }
    }
}
