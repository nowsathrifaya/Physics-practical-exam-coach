...
enum StudyNoteDifficulty: String {
    case easy, medium, frequentlyTested

    var badge: String {
        switch self {
        case .easy: return "\u{1F7E2} Easy"
        case .medium: return "\u{1F7E1} Medium"
        case .frequentlyTested: return "\u{1F534} Frequently Tested"
        }
    }
}
...
struct StudyNote: Identifiable {
    ...
    /// How commonly this trips students up / how heavily it's tested —
    /// defaults to medium so none of the existing notes below needed
    /// editing to add this; only the ones worth flagging as notably
    /// easier or harder override it explicitly.
    let difficulty: StudyNoteDifficulty

    init(id: String, category: StudyNoteCategory, title: String, rule: String, examples: String, doNotDo: String = "", tip: String = "", curricula: Set<Curriculum> = [], difficulty: StudyNoteDifficulty = .medium) {
        self.id = id
...
enum StudyNotesBank {
    ...
    static let all: [StudyNote] = [
        ...
        StudyNote(
            id: "prec_01", category: .instrumentPrecision, title: "Rule of Thumb — Precision", difficulty: .easy,
        ...
        StudyNote(
            id: "prec_02", category: .instrumentPrecision, title: "Length Instruments", difficulty: .easy,
        ...
        StudyNote(
            id: "prec_03", category: .instrumentPrecision, title: "Electrical Instruments", difficulty: .medium,
        ...
        StudyNote(
            id: "prec_04", category: .instrumentPrecision, title: "Volume, Time, Temperature, Mass, Angle", difficulty: .medium,
        ...
        StudyNote(
            id: "sf_01", category: .sigFigs, title: "Finding the Mean — s.f. Rule", difficulty: .medium,
        ...
        StudyNote(
            id: "sf_02", category: .sigFigs, title: "Calculated Quantities from Measured Values", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "sf_03", category: .sigFigs, title: "Calculated Quantities from an Equation", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "sf_04", category: .sigFigs, title: "Gradient Significant Figures", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "tab_01", category: .tabulation, title: "Table Headings — Solidus Notation", difficulty: .medium,
        ...
        StudyNote(
            id: "tab_02", category: .tabulation, title: "Table — Precision and Consistency", difficulty: .medium,
        ...
        StudyNote(
            id: "tab_03", category: .tabulation, title: "Repeat Readings and Average", difficulty: .easy,
        ...
        StudyNote(
            id: "graph_01", category: .graphPlotting, title: "The 4 Graph Criteria [1 mark each]", difficulty: .medium,
        ...
        StudyNote(
            id: "graph_02", category: .graphPlotting, title: "Axes Labels and Scale", difficulty: .easy,
        ...
        StudyNote(
            id: "graph_03", category: .graphPlotting, title: "Straight Line vs. Curve — How to Tell", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "graph_04", category: .graphPlotting, title: "Anomalous Points", difficulty: .medium,
        ...
        StudyNote(
            id: "grad_01", category: .gradient, title: "4 Steps to Find Gradient", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "grad_02", category: .gradient, title: "Reading Values from a Graph", difficulty: .medium,
        ...
        StudyNote(
            id: "prec_elec_01", category: .precautions, title: "Electricity Experiment Precautions", difficulty: .medium,
        ...
        StudyNote(
            id: "prec_heat_01", category: .precautions, title: "Heat Experiment Precautions", difficulty: .medium,
        ...
        StudyNote(
            id: "prec_light_01", category: .precautions, title: "Light Experiment Precautions", difficulty: .medium,
        ...
        StudyNote(
            id: "prec_mech_01", category: .precautions, title: "Mechanics Experiment Precautions", difficulty: .medium,
        ...
        StudyNote(
            id: "conc_01", category: .conclusions, title: "Writing Relationship Statements", difficulty: .medium,
        ...
        StudyNote(
            id: "conc_02", category: .conclusions, title: "Common Sources of Error", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "plan_01", category: .planning, title: "Planning Template — 9 Steps", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "plan_02", category: .planning, title: "Linearising Equations for Planning", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "plan_03", category: .planning, title: "6 Required Data Points", difficulty: .frequentlyTested,
        ...
        StudyNote(
            id: "plan_04", category: .planning, title: "Identifying Variables", difficulty: .medium,
        ...
        StudyNote(
            id: "fmt_sg_01", category: .examFormat, title: "SEAB 6091 Paper 3 — How It's Marked", difficulty: .easy,
        ...
        StudyNote(
            id: "fmt_ig_01", category: .examFormat, title: "Cambridge 0625/0972 Paper 5 — How It's Marked", difficulty: .easy,
        ...
        StudyNote(
            id: "fmt_waec_01", category: .examFormat, title: "WAEC Paper 3 — How It's Marked", difficulty: .easy,
        ...
        StudyNote(
            id: "fmt_neco_01", category: .examFormat, title: "NECO Paper 3 — How It's Marked", difficulty: .easy,
        ...
        StudyNote(
            id: "fmt_gen_01", category: .examFormat, title: "General Mode — What This Covers", difficulty: .easy,
