...
- Remaining curriculum simulations still on the old `GenericSimulationView` slider shell, pending conversion to this pattern one at a time, in curriculum priority order: Lens Focusing, Resistance Wire, Refraction, Vernier Caliper (simulation), Cooling Curve, Filament Lamp.
